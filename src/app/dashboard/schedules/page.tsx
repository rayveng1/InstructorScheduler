...
export default function SchedulesPage() {
  ...
  return (
    <div className="p-4 h-full overflow-y-scroll relative">
      ...
      {selectedPage === 0 ? (
        <section className="dark:bg-slate-800 bg-white rounded-r-lg md:w-5/6 mx-auto rounded-lg h-2/3 m-4 ">
          <h1 className="px-3 py-3 text-2xl font-semibold">Preferences</h1>
          <div className="flex">
            <h2 className="px-3 py-3 text-xl font-semibold">Courses</h2>
            <Link
          ...
          <div className="flex">
            <p className="px-3 py-3 text-lg">Add your courses here</p>
          ...
          <ul className=" w-1/6 bg-utdorange/50 border-2 border-utdorange rounded-lg mx-2 py-2 hover:bg-emerald-200 hover:border-green-400 duration-300 cursor-pointer ml-auto">
            <p className="w-full text-center">Generate Schedule</p>
          </ul>
        </section>
      ) : (
